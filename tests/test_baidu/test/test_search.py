...
from tests.test_baidu.page.objects.searchpage import SearchPage
...
class TestSearch:
    ...
    def open_baidu(self, drivers):
        ...
        search.get_url(cm.ini['baidu'].url)
        airtest.assert_template(get_image(cm.airimages['baidu'], "百度首页logo"))
